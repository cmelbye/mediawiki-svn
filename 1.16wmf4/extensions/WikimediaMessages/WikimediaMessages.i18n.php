...
$messages['mk'] = array(
	...
	'group-interface_editors' => 'Уредници на интерфејс',
	...
	'group-interface_editors-member' => 'уредник на интерфејс',
	...
	'grouppage-interface_editors' => '{{ns:project}}:Уредници на интерфејс',
...
$messages['ml'] = array(
	...
	'wikimedia-copyrightwarning' => 'സേവ് ചെയ്യുമ്പോൾ, താങ്കൾ എഴുതിച്ചേർത്തത് അനുമതി പിന്നീട് മാറ്റാൻ പറ്റാത്തവിധം [http://creativecommons.org/licenses/by-sa/3.0/ ക്രിയേറ്റീവ് കോമൺസ്/ഷെയർ എലൈക് 3.0], [http://www.gnu.org/copyleft/fdl.html ജി.എഫ്.ഡി.എൽ.] എന്നീ അനുമതിപത്രങ്ങൾ പ്രകാരം വിതരണം ചെയ്യുന്നതിനായി അംഗീകരിച്ചിരിക്കണം. താങ്കൾ മാറ്റങ്ങൾ വരുത്തിയ താളിനെ പുനരുപയോഗിക്കുന്നവർ, കുറഞ്ഞ പക്ഷം അതിലേക്ക് ഒരു ഹൈപ്പർലിങ്കോ യു.ആർ.എല്ലോ ഉപയോഗിച്ച് കടപ്പാട് നൽകുമെന്നും മനസ്സിലാക്കിയിരിക്കണം. 
