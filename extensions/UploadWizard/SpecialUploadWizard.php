	...
	public function execute( $subPage ) {
		...
		if ( $wgResourceLoader ) {
			...
			*/
			...
			//$scripts = array(
				// jquery standard stuff -- can we load this from vector itself?
				//"extensions/UploadWizard/resources/jquery.ui/ui/ui.core.js",	
			//);

			// in ResourceLoader, these will probably have names rather than explicit script paths
			$dependencies = array(
			...
			if ( $langCode !== 'en' ) {
				$scripts[] = $module['languageScripts'][$langCode];
			}
