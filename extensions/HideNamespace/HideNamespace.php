...
function wfHideNamespaceSetup() {
	...
	$wgHooks['LanguageGetMagic'][] = array( &$extHidensObj, 'onLanguageGetMagic' );
...
class ExtensionHideNamespace {
	...
	/**
	 * Get localized magic words
	 */
	public function onLanguageGetMagic( &$mw, $lang ) {
		require( dirname( __FILE__ ) . DIRECTORY_SEPARATOR .
			'HideNamespace.i18n.magic.php' );
